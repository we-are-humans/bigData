...
// 扇形图
var myChart = echarts.init(document.getElementById("industryChar"));
...
// 车型分类
var myChart_2 = echarts.init(document.getElementById("vehicleChar"));
option_2 = {
    title : {
        text: '车型分类',
        textStyle:{color:
...
// 车辆充电高峰
var myChart_3 = echarts.init(document.getElementById("chargChar"));
...
// 本月行驶里程
var myChart_4 = echarts.init(document.getElementById('benyueChar'));
...
(function echarts_5() {
    ...
    var myChart = echarts.init(document.getElementById('warnChar'));
...
(function echarts_6() {
    // 基于准备好的dom，初始化echarts实例
    var myChart = echarts.init(document.getElementById('dianchiChar'));
